  ...
  return (
    <div className={`${cl.sidebar} ${sidebarVisibility ? cl.active : ""}`}>
      <div className={cl.links}>
        <NavLink to="/Metric/inbox" className={cl.link}>
        ...
        <NavLink to="/Metric/today" className={cl.link}>
          <div className={cl.navLinkLeft}>
        ...
        <NavLink to="/Metric/upcoming" className={cl.link}>
          <div className={cl.navLinkLeft}>
        ...
        <NavLink to="/Metric/overdue" className={cl.link}>
          <div className={cl.navLinkLeft}>
